        ...
        <div className="flex flex-col justify-start items-center gap-12 sm:gap-16 md:gap-20 lg:gap-[64px] w-full">
          ...
          <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 md:gap-10 lg:gap-[18px] w-full justify-center items-center">
            ...
            >
              ...
              <p className="font-normal text-left text-[#032a48] absolute top-20 left-5 right-5 sm:top-24 sm:left-6 sm:right-6 md:top-24 md:left-8 md:right-8 lg:top-[122px] lg:left-[29px] text-base sm:text-lg md:text-lg lg:text-[18px] leading-relaxed lg:leading-[23px] w-[calc(100%-150px)] sm:w-[calc(100%-60px)] md:w-[calc(100%-240px)] lg:w-[314px]"
                style={{ 
                  fontFamily: 'Roboto',
                  fontWeight: 400,
                  fontSize: '18px'
                }}>
                Lo que antes lo hacía una persona, Prisma lo hace solo. No pagas salarios,
                 no das instrucciones, no corriges errores.
              </p>
              ...
              <motion.div
                ...
                className="absolute bottom-0 right-4 lg:right-6 w-56 sm:w-64 md:w-72 lg:w-[300px] h-[342px] z-1"
              >
                <Image
