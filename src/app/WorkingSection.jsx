        ...
        <div className="flex flex-col justify-start items-center gap-12 sm:gap-16 md:gap-20 lg:gap-[64px] w-full">
          ...
          <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 md:gap-10 lg:gap-[18px] w-full justify-center items-center">
            ...
            >
              ...
              <h3 className="font-medium text-left text-[#1a3866] absolute top-5 left-5 sm:top-6 sm:left-6 md:top-6 md:left-8 lg:top-[25px] lg:left-[51px] text-lg sm:text-xl md:text-2xl lg:text-[30px] leading-snug lg:leading-[40px] w-[calc(100%-40px)] sm:w-[calc(100%-48px)] md:w-[calc(100%-64px)] lg:w-[500px] z-10"
                style={{ 
                  fontFamily: 'Roboto', 
                  fontWeight: 500,
                  letterSpacing: '0%',
              ...
              <p className="font-normal text-left text-text-muted absolute top-16 left-5 right-5 sm:top-20 sm:left-6 sm:right-6 md:top-20 md:left-8 md:right-8 lg:top-[70px] lg:left-[51px] lg:right-[51px] text-sm sm:text-base md:text-base lg:text-[16.5px] leading-relaxed lg:leading-6 z-10 pb-56 sm:pb-56 md:pb-48 lg:pb-0 w-[calc(100%-40px)] sm:w-[calc(100%-48px)] md:w-[calc(100%-64px)] lg:w-[500px]"
                style={{ 
                  fontFamily: 'Roboto',
                  fontWeight: 400,
                  letterSpacing: '0%',
            ...
            >
              <h3 className="font-medium text-left text-[#032a48] absolute top-5 left-5 sm:top-6 sm:left-6 md:top-6 md:left-8 lg:top-[29px] lg:left-[29px] text-lg sm:text-xl md:text-2xl lg:text-[30px] leading-snug lg:leading-[40px] w-[calc(100%-140px)] sm:w-[calc(100%-200px)] md:w-[calc(100%-280px)] lg:w-[350px]"
                style={{ 
                  fontFamily: 'Roboto',
                  fontWeight: 500
                }}>
              ...
              <p className="font-normal text-left text-[#032a48] absolute top-20 left-5 right-5 sm:top-24 sm:left-6 sm:right-6 md:top-24 md:left-8 md:right-8 lg:top-[133px] lg:left-[29px] text-base sm:text-lg md:text-lg lg:text-[18px] leading-relaxed lg:leading-[23px] w-[calc(100%-150px)] sm:w-[calc(100%-200px)] md:w-[calc(100%-280px)] lg:max-w-[420px]"
                style={{ 
                  fontFamily: 'Roboto',
                  fontWeight: 400
                }}>
              ...
              <motion.div
                ...
                className="absolute bottom-0 right-0 sm:right-4 md:right-8 lg:right-[30px] w-40 sm:w-36 md:w-[180px] lg:w-[200px] h-auto z-1"
              >
                <Image
